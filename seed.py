...
# in the database located at 'db/task_manager.db' using Faker for fake data.
# """
...
# def seed_database():
#     """Populate the database with statuses, users, and tasks."""
#     conn = sqlite3.connect(DB_PATH)
#     cur = conn.cursor()

#     # Insert statuses
#     statuses = ["new", "in progress", "completed"]
#     cur.executemany("INSERT INTO status (name) VALUES (?)", [(s,) for s in statuses])
